...
Notebook artifact created at `reports/duui_py_evaluation_presentation.ipynb`.

Generated support files:

- `reports/figures/*.png`
- `reports/data/*.csv`
- `reports/duui_py_evaluation_presentation.md`

The notebook uses preserved numeric artifacts for spaCy, TaxoNERD, and Gazetteer. GNFinder implementation and harness evidence is included, but row-level GNFinder baseline-versus-async timings were not preserved in this checkout, so GNFinder is not plotted as a primary numeric result.
